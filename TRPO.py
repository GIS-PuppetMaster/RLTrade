...
if __name__ == '__main__':
    ...
    checkpointPath = './checkpoints/' + exp_name
    ...
    saveBestCallback = MyEvalCallback(eval_env, best_model_save_path='./BestModels/' + exp_name + '/',
    ...
    model.save(os.path.join(wandb.run.dir, exp_name))
    # model.save("model")
